...
bool DeviceData::insertChannelDataCHild(ChannelData &channel)
{
    m_qlistchanneldata.append(channel);
}

QList<ChannelData>& DeviceData::getChannelData()
{
    return m_qlistchanneldata;
}

void DeviceData::debug()
{
    qDebug() << m_qdevicename << m_qip << m_qiport << m_qusername << m_qpassword;
    foreach (ChannelData data, m_qlistchanneldata) {
        qDebug()<<data.getChannelName()<<data.getChannelNum()<<data.getProtocolTypeQstring()<<data.getStreamTypeQstring()<<data.getSaveDir();
    }
}

QString DeviceData::getSerialNum() const
{
    return serialNum;
}

void DeviceData::setSerialNum(const QString &value)
{
    serialNum = value;
}

QString DeviceData::getMapId() const
{
    return mapId;
}

void DeviceData::setMapId(const QString &value)
{
    mapId = value;
}
